(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var prevTime$1 = 0;
    var onNextFrame$1 = typeof window !== 'undefined' && window.requestAnimationFrame !== undefined
        ? function (callback) { return window.requestAnimationFrame(callback); }
        : function (callback) {
            var timestamp = Date.now();
            var timeToCall = Math.max(0, 16.7 - (timestamp - prevTime$1));
            prevTime$1 = timestamp + timeToCall;
            setTimeout(function () { return callback(prevTime$1); }, timeToCall);
        };
    ...
    var setWillRunNextFrame$1 = function (willRun) { return (willRunNextFrame$1 = willRun); };
    var _a = stepsOrder$1.reduce(function (acc, key) {
        var step = createStep$1(setWillRunNextFrame$1);
        ...
        sync: {},
        cancelSync: {}
    }), steps$1 = _a.steps, sync$1 = _a.sync, cancelSync = _a.cancelSync;
    var processStep$1 = function (stepId) { return steps$1[stepId].process(frame$1); };
    var processFrame$1 = function (timestamp) {
        ...
        if (!useDefaultElapsed$1)
            defaultElapsed$1 = frame$1.delta;
    ...
    var getFrameData$1 = function () { return frame$1; };
